...
public abstract class SpriteLoader extends Loader {
    ...
    public SpriteLoader(String PathToMaps) {
        ...
        Dimension[] dimensions1 = new Dimension[]{new Dimension(30, 40), new Dimension(30, 30),
            new Dimension(30, 30), new Dimension(30, 30), new Dimension(30, 60),
