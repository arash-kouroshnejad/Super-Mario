...
public class StoreController extends FrameController {
    public StoreController(User usr) {
        ...
        try {
            jmp.setIcon(new ImageIcon(ImageIO.read(new File("./src/Resources/Sprites/DonkeyKong.png")).getScaledInstance(50 ,50, Image.SCALE_DEFAULT)));
            ammo.setIcon(new ImageIcon(ImageIO.read(new File("./src/Resources/Sprites/Monster.png")).getScaledInstance(50, 50, Image.SCALE_DEFAULT)));
            speed.setIcon(new ImageIcon(ImageIO.read(new File("./src/Resources/Sprites/Steve.png")).getScaledInstance(50, 50, Image.SCALE_DEFAULT)));
            coin.setIcon(new ImageIcon(ImageIO.read(new File("./src/Resources/Sprites/PacMan.png")).getScaledInstance(50, 50, Image.SCALE_DEFAULT)));
        } catch (Exception e) {
